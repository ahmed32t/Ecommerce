                            ...
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{route('newindex')}}" class="">
                                                <div class="text">see items</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <div class="popup-wrap user type-header">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li class="menu-item">
                                                <form method="POST" action="{{route('user.logout')}}"  class="" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                                    @csrf
